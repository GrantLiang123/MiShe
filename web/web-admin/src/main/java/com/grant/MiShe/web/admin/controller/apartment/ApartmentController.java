...
import com.grant.MiShe.web.admin.service.ApartmentInfoService;
...
public class ApartmentController {
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        ...
        apartmentInfoLambdaUpdateWrapper.eq(ApartmentInfo::getId,id).set(ApartmentInfo::getIsRelease,status);
