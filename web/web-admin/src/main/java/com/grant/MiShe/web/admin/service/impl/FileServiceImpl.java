...
import com.grant.MiShe.common.minio.MinioProperties;
import com.grant.MiShe.web.admin.service.FileService;
import io.minio.*;
...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
        ...
        minioClient.putObject(PutObjectArgs.builder().bucket(minioProperties.getBucketName()).contentType(file.getContentType()).stream(file.getInputStream(), file.getSize(), -1).object(filename).build());
